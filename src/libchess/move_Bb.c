        ...
        int hod)
{
    ...
    if (hod) {
        // up
        printf("%d %d %d %d %d",
               pos_y_first - pos_y_second > 0,
               i,
               pos_y_first - pos_y_second == pos_x_first - pos_x_second,
               pos_y_first - pos_y_second,
               pos_x_first - pos_x_second);
        if (pos_y_first - pos_y_second > 0 && i
            && abs(pos_y_first - pos_y_second)
                    == abs(pos_x_first - pos_x_second)) {
            // up-left
